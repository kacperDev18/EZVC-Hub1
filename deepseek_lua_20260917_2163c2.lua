-- EZVC Hub v2.2 - Restored Main Statistics + live Record/Play counters
...
lb(hdr,"v2.2",92,0,90,38,MT,9,false)
...
-- ============================================================
-- MAIN PAGE (Statistics + Automation)
-- ============================================================
local mP=pg("Main")
-- Statistics card (restored from v1.7)
...
-- Automation card (below Statistics)
...
-- ============================================================
-- MACRO PAGE (Mode hidden, Statistics kept)
-- ============================================================
local mP2=pg("Macro")
...
rfC()
N("EZVC","Ready v2.2")
print("[EZVC] v2.2 loaded | mode="..(HOOK_OK and HOOK_MODE or "passive"))